...
{
    #region Fields
    public float nodeTotalCost=0;         //Total cost so far for the node
    public float estimatedCost=0;         //Estimated cost from this node to the goal node
    public bool bObstacle=false;              //Does the node is an obstacle or not
	public Node parent=null;                 //Parent of the node in the linked list
	public Vector3 position=Vector3.zero;            //Position of the node
    public floor tile=null;
    #endregion
