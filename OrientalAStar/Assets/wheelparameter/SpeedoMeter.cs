...
public class SpeedoMeter : MonoBehaviour {
    ...
    void OnGUI()
    {
		...
		//speedText.GetComponent<Text>().text=(int) GetComponent<Rigidbody>().velocity.magnitude * 2.23693629f + string.Empty;

		z = - Mathf.Lerp(0,  220, (this.transform.parent.GetComponent<Rigidbody>().velocity.magnitude * 2.23693629f) / m_Car.i_maxSpeed);
